# O8 — Kostet die Temporal-Spalte mehr als sie bringt? (Vorab-Registrierung)
...
mit O1 — und die betrifft die Temporal-Spalte nicht: die Arme dieser Frage
...
für Temporal−bare um null — eine Spalte, die über Serien positiv migriert
...
{
  "id": "O8",
  "frage": "Kostet die Temporal-Spalte mehr als sie bringt?",
  "serie_art": "tagesserie",
  "serie_ab": "20260813",
  "naechte": 5,
  "arme": {"mit": "mlp32-temporal", "ohne": "mlp32"},
