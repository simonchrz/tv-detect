...
def main():
    ...
    ap.add_argument("--tagesserie-nur-arm", default=None, metavar="ARCH",
                    help="Nur DIESEN Arm fitten. Fuer Parallelbetrieb: ein "
                         ...
                         "⚠️ NUR MIT --stichtag benutzen, fuer JEDEN "
                         "Prozess derselbe. Ohne ihn liest jeder Prozess "
                         "seine eigene Uhr, age_mult faellt anders aus, "
                         "und zwei Prozesse mit IDENTISCHER Konfiguration "
                         "und gleichem Seed weichen um Median 0.0073 im "
                         "golden_median ab (gemessen 2026-09-06, "
                         "Einzelwerte bis 0.0116) — mehr als jeder Effekt, "
                         "der je durch diesen Modus gemessen wurde. MIT "
                         "gleichem Stichtag sind die Gewichte bitgleich "
                         "und die Laeufe vergleichbar (2026-09-12: "
                         "Median |Delta| 0.0000 ueber vier Seeds). Fuer "
                         "einen Gewichtungs-Unterschied wie O18 ist dieser "
                         "Modus dann PFLICHT, nicht Notbehelf: der "
                         "Schalter wirkt vor dem Armlauf, zwei Arme in "
                         "einem Prozess messen zweimal dasselbe.")
    ...
    # the existing split.
    #
    # TEST_SET_EXCLUDE lebt seit 2026-09-14 in scripts/test_ausschluss.py --
    # EINE Definition fuer Trainer, golden_v3_vorschlag.py und
